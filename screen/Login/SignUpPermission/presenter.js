					...
					<View style={{borderBottomWidth: 1,borderColor: '#CCCFD2'}}>
						...
						<ScrollView nestedScrollEnabled={true} style={{ flex: 1, height: height * 0.4 }}>
							<Text>
								...
								2. 개인정보 파일 현황{"\n"}
								1. 개인정보 파일명 : '동방' 개인정보- 개인정보 항목 : 이메일, 휴대전화번호, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 대학교명- 수집방법 : 모바일 앱- 보유근거 : 본인 동의- 보유기간 : 5년- 관련법령 : 소비자의 불만 또는 분쟁처리에 관한 기록 : 3년, 표시/광고에 관한 기록 : 6개월{"\n"}
								...
								1.`모바일 앱 회원가입 및 관리``모바일 앱 회원가입 및 관리`와 관련한 개인정보는 수집.이용에 관한 동의일로부터`5년`까지 위 이용목적을 위하여 보유.이용됩니다.-보유근거 : 본인 동의-관련법령 : 1)소비자의 불만 또는 분쟁처리에 관한 기록 : 3년2) 표시/광고에 관한 기록 : 6개월{"\n"}
								2.'모바일 앱 사진 업로드'
모바일 앱 회원 가입 시 학생증 인증란에 업로드 되는 사진은 인증수단으로서 목적 외에는 다른목적으로 일체 사용되지 않습니다. 회원가입 시 업로드한 학생증 사진 파일은 인증 즉시 파기됩니다.
모바일 앱 내에 동아리 생성 시 입력하는 동아리 메인 사진, 동아리 로고 사진은 앱 내에서 다른 이용자들에게 노출되기 위해 사용됩니다. 업로드된 사진은 다른 이용자가 무단으로 복제 및 사용할 수 없으며, 앱 내에 게시되는 용도 외에는 일체 사용되지 않습니다.
-보유근거 : 본인 동의
-관련법령 : 정보통신망법 제64조 제4항에 따른 시정 명령, 동법 제76조 제1항 제1호 - 제12호, 정보통신망법 제71조 제1항 제1호, 동법 제64조의3제1항제1호, 개인정보보호법 제75조 제1항 제1호
...
1. `'동방' 관리팀`- 위탁받는 자 (수탁자) : '동방'- 위탁하는 업무의 내용 : 회원제 서비스 이용에 따른 본인확인, 불만처리 등 민원처리, 고지사항 전달, 신규 서비스(제품) 개발 및 맞춤 서비스 제공, 이벤트 및 광고성 정보 제공 및 참여기회 제공- 위탁기간 : 5년② `동방`은 위탁계약 체결시 개인정보 보호법 제25조에 따라 위탁업무 수행목적 외 개인정보 처리금지, 기술적․관리적 보호조치, 재위탁 제한, 수탁자에 대한 관리․감독, 손해배상 등 책임에 관한 사항을 계약서 등 문서에 명시하고, 수탁자가 개인정보를 안전하게 처리하는지를 감독하고 있습니다.③ 위탁업무의 내용이나 수탁자가 변경될 경우에는 지체없이 본 개인정보 처리방침을 통하여 공개하도록 하겠습니다.{"\n"}
								...
								1`모바일 앱 회원가입 및 관리`- 필수항목 : 이메일, 비밀번호, 로그인ID, 성별, 생년월일, 이름, 서비스 이용 기록, 접속 로그, 쿠키, 접속 IP 정보, 대학교명{"\n"}
